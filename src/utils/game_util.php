...
if (isset($_POST['mode']) && isset($_POST['difficulty']) && isset($_POST['market_struct']) 
	...
	if ($_POST['gameId']) {
		...
		$sql = "INSERT INTO Games (name, equilibrium, type, course_id, difficulty, mode, market_struct, macro_econ, rand_events, time_limit, num_rounds, demand_intercept, demand_slope, fixed_cost, const_cost)
		VALUES ('".$_POST['gameName']."', '".$_POST['equilibrium']."', '".$_POST['type']."', '".$_POST['course_id']."', '".$_POST['difficulty']."', '".$_POST['mode']."', '".$_POST['market_struct']."', '".$_POST['macroEconomy']."', '".$rand."', '".$_POST['limit']."', '".$_POST['numRounds']."', '".$_POST['demand_intercept']."', '".$_POST['demand_slope']."', '".$_POST['fixed_cost']."', '".$_POST['const_cost']."')";
		if ($mysqli->query($sql) === TRUE) {

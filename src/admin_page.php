  ...
  <body style="background-color: #d3f6ff;">
	...
	<div class="grid-container" style="margin-top: 5%;">
		...
		<div id="game_options" style="display: none;">
			...
			<?php } ?>
						<div class="cell grow">
						  	<a onclick="window.location = window.location.origin+window.location.pathname+'?PHPSESSID=<?= $_GET["PHPSESSID"]."&game=".$game["id"]?>'">
    ...
    <script src="https://ip-172-22-145-182.oit.nd.edu:8080/socket.io/socket.io.js"></script>
    <script type="text/javascript">
    	// connect to server
    	var socket = io.connect('https://ip-172-22-145-182.oit.nd.edu:8080/');

...
io.on('connection', function(socket) { 
    ...
    socket.on('leaveGame', function(user, id) {
      ...
      // DON'T WANT TO DELETE GAME OBJECT YET (THIS WILL REMOVE ENTRY FROM INSTRIUCTOR RESULTS)
      // SHOULD OBJECT BE ERASED IF USER STARTS NEW GAME? OR JUST ALLOW MULTIPLE ENTRIES FOR A USER IN RESULTS TABLE?
      // LATER OPTION WOULD ONLY RESET WHEN INSTRUCTOR TOGGLES THE SESSION ON/OFF
//         for (var i = 0; i < gameCollection.totalGameCount; i++) {
